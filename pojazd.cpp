...
pojazd::pojazd(int _liczba_kol, double _cisnienie_w_oponach, double _max_cisnienie_opon) : liczba_kol(_liczba_kol), cisnienie_w_oponach(_cisnienie_w_oponach), max_cisnienie_opon(_max_cisnienie_opon)
{
}
